...
export const chapter_possession_prelude = [
  ...
  },
  {
    ...
    "type": "dialogue",
    "characterId": "vargas",
    "text": "然后——在我还没来得及做出任何动作之前——瓦尔加斯的声音改变了。不再是张扬的威胁，而是一种低沉的、直接在我脑海中响起的低语。'安文……我知道你在想什么。意识转移，对吗？你祖父的小把戏。但你没有想过另一种可能性吗？不进入她的身体，而是让她的身体——和你——都成为某种更伟大的存在的一部分。'",
  ...
  },
  {
    ...
    "type": "dialogue",
    "characterId": "vargas",
    "text": "'你感受到那枚护身符的力量了吧？那不仅仅是一件转移意识的工具——它是钥匙。如果你愿意接受我的引导，我能教你如何真正地掌控这具精灵之躯——不是作为临时的租客，而是作为永久的拥有者。爱莉希雅的意识会被完全抹去，而你——安文——将获得精灵的寿命、魔力与力量。留下来，与我合作。我们一起统治这片森林——不，这片大陆。'",
    "effects": ["dim"],
