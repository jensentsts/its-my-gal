...
export const chapter_elysia_life = [
  {
    ...
    "characterId": "player",
    "texts": [
      "我把自己的——安文的——身体小心地安置在祭坛旁一处安全的石凹中。护身符在他脖子上继续发出微弱的绿光，维持着身体最低限度的生命体征。祖父的笔记里说，只要护身符不离开本体太远，意识随时可以返回。我暂时松了口气。",
      "踏出祭坛，重新走在森林小径上的感觉完全不同了。爱莉希雅的眼睛——现在是我的眼睛——看到的森林比原先丰富得多。普通的树木上浮动着肉眼不可见的光晕，林间的雾气呈现出一层淡淡的金辉，那是森林自身的魔力在流动。耳朵能捕捉到数十步外松鼠踏过枯叶的声响。连脚底踩在泥土上的触感都比人类时细腻了十倍——我能分辨出覆于泥土表面的每一粒沙砾、每一片薄苔的纹理。",
      "我穿过森林，走向爱莉希雅在笔记里提到过的林间小屋。那是一间用古老橡木搭建的小巧屋舍，爬满了发光的藤蔓。推开门的瞬间，一股淡淡的草木熏香扑鼻而来——这是她的住处，她的气味，她的生活。房间里面布置得简洁而雅致，墙上挂着几幅手绘的植物图鉴，桌上放着一叠写了一半的巡林记录，窗台上摆着几盆我叫不出名字的发光植物。"
    ],
    "textEffects": [
      null,
      {"effects": []},
