...
export const chapter_ruins_exploration_bad = [
  ...
  },
  {
    ...
    "type": "dialogue",
    "characterId": "player",
    "text": "我不再知道自己在哪。森林、祭坛、壁画——一切都融化成了一片无法穿透的灰白色浓雾。我听见爱莉希雅在呼喊我的名字，但那声音越来越远，越来越轻，像是从另一个世界传来的回声。迷雾涌入了我的口鼻，我的耳朵，我的眼睛，最后涌入了我的灵魂。",
  ...
  },
  {
    ...
    "type": "dialogue",
    "characterId": "player",
    "text": "不知过了多久——几分钟？几小时？几天？——我发现自己站在一片完全陌生的森林中。爱莉希雅不见了。护身符的绿光已经完全熄灭。四周围绕着一模一样的古树和一模一样的迷雾，每一条路都通向另一个完全相同的场景。我在森林中永远地迷失了。脚步声和呼唤声混杂在一起，分不清哪些是我的，哪些是森林中无数前驱者的幽灵。",
    "effects": ["flashBlack", "vignette"],
    "screenEffect": "snow?density=45"
  },
  {
    "sceneId": "ruins_entrance",
    "type": "ending",
