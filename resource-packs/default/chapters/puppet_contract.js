...
export const chapter_puppet_contract = [
  ...
  },
  {
    ...
    "type": "dialogue",
    "characterId": "player",
    "text": "我的意识——被剥离出来的、透明的、脆弱的意识——被栓在了祭坛的石柱上。暗影的丝线穿过了我的手腕和脚踝，将我固定在半空中，像一个悬挂在舞台上的提线木偶。我能看到、能听到、能感受到周围的一切——但无法移动，无法说话，无法做任何事情。瓦尔加斯操控着我的身体和爱莉希雅的身体并肩消失在遗迹的阴影中。",
  ...
  },
  {
    ...
    "type": "dialogue",
    "characterId": "player",
    "text": "祭坛恢复了寂静。只有护身符的碎片散落在石面上，反射着微弱的、即将熄灭的绿光。我被绑在自己的灵魂中，永远地注视着这空无一人的祭坛——阿瓦隆最后一道防线崩溃的地方。傀儡的契约，就是这样：你献出一切，换来的只是永恒的无尽监禁。",
    "effects": ["flashBlack", "dim"],
