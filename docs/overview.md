...
- 👥 **角色名录** — 角色档案与立绘展示
- 💾 **存档/读档系统** — 16 槽位自由读写
- 🚪 **退出暂存** — 保存进度并返回主菜单，下次可继续
- ⌨️ **键盘快捷键** — ESC/Space/Ctrl+S/Ctrl+O/Ctrl+N
- ✨ **DOM 粒子特效** — 雨、雪、樱花、火焰等多种环境效果
- 📦 **资源包系统** — 支持资源包打包、加载、切换
- ✏️ **剧情树编辑器** — 浏览器中的可视化编辑工具，支持撤销/重做/自动布局
- 💬 **自定义对话框** — 游戏内 alert/confirm/prompt（非浏览器弹窗）
- 🗑️ **清除所有记忆** — 长按按钮清除全部存储数据
- 📱 **移动端适配** — 自适应缩放，支持手机游玩
